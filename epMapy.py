...
try:
    ...
    st2 = time.time()
    elapsed_time = st2 - st0
    tmessage = f'path not found or file does not exist. Run script again! Total execution time: {elapsed_time:.1f} seconds'
    print(tmessage)

else:
    st3 = time.time()
    elapsed_time = st3 - st0
    tmessage = f'loading of data was successful! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    st1 = time.time()
    #Reading name of the files for plotting
    ...
    tmessage = f'Dataframes were created! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    st5 = time.time()
    elapsed_time = st5 - st0 - (st1p-st1)
    tmessage = f'anhydrous-based oxide, mol, cation and normative mineralogy compositions calculated! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    for j in range (d):
        for i in range (c):
            if (Q[j,i] <20) & (Fsp[j,i]>40) & (px[j,i]>10):
                ...
                mrg[j,i]=5
    st6 = time.time()
    elapsed_time = st6 - st0 - (st1p-st1)
    tmessage = f'phases determined! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    a0       = axs[0,0].imshow(Q,cmap='viridis',vmin=0, vmax=100)
    a0.cmap.set_under('black')
    axs[0,0].set_title("Q wt.%")
    axs[0,0].axis("off")
    fig.colorbar(a0)
    a1       = axs[0,1].imshow(Fsp,cmap='viridis',vmin=0, vmax=100)
    a1.cmap.set_over('black')
    axs[0,1].set_title("ab + or + an wt.%")
    axs[0,1].axis("off")
    fig.colorbar(a1)
    a2       = axs[0,2].imshow(px,cmap='viridis',vmin=0, vmax=100)
    a2.cmap.set_over('black')
    axs[0,2].set_title("px wt.%")
    axs[0,2].axis("off")
    fig.colorbar(a2)
    a3       = axs[1,0].imshow(ol,cmap='viridis',vmin=0, vmax=100)
    a3.cmap.set_over('black')
    axs[1,0].set_title("ol wt.%")
    axs[1,0].axis("off")
    fig.colorbar(a3)
    a4       = axs[1,1].imshow(ox,cmap='viridis',vmin=0, vmax=100)
    a4.cmap.set_over('black')
    axs[1,1].set_title("mt + ilm wt.%")
    axs[1,1].axis("off")
    fig.colorbar(a4)
    a5       = axs[1,2].imshow(ap,cmap='viridis',vmin=0, vmax=100)
    ...
    st7 = time.time()
    elapsed_time = st7 - st0 - (st1p-st1)
    tmessage = f'Normative mineralogy plots done! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    st8 = time.time()
    elapsed_time = st8 - st0 - (st1p-st1)
    tmessage = f'Anhydrous-based oxide plots done! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)

    plt.figure(figsize=(6.5*cm,6.5*cm))
    fig, axs = plt.subplots(2, 3)
    a0       = axs[0,0].imshow(SiO2p,cmap='viridis',vmin=0, vmax=105)
    a0.cmap.set_over('black')
    axs[0,0].set_title("SiO$_{2}$ wt.%")
    axs[0,0].axis("off")
    fig.colorbar(a0)
    a1       = axs[0,1].imshow(Al2O3p,cmap='viridis',vmin=0, vmax=45)
    a1.cmap.set_over('black')
    axs[0,1].set_title("Al$_{2}$O$_{3}$ wt.%")
    axs[0,1].axis("off")
    fig.colorbar(a1)
    a2       = axs[0,2].imshow(FeOp,cmap='viridis',vmin=0, vmax=100)
    a2.cmap.set_over('black')
    axs[0,2].set_title("FeO wt.%")
    axs[0,2].axis("off")
    fig.colorbar(a2)
    a3       = axs[1,0].imshow(MgOp,cmap='viridis',vmin=0, vmax=45)
    a3.cmap.set_over('black')
    axs[1,0].set_title("MgO wt.%")
    axs[1,0].axis("off")
    fig.colorbar(a3)
    a4       = axs[1,1].imshow(Na2Op,cmap='viridis',vmin=0, vmax=15)
    a4.cmap.set_over('black')
    axs[1,1].set_title("Na$_{2}$O wt.%")
    axs[1,1].axis("off")
    fig.colorbar(a4)
    a5       = axs[1,2].imshow(totp,cmap='viridis',vmin=1, vmax=100)
    ...
    st9 = time.time()
    elapsed_time = st9 - st0 - (st1p-st1)
    tmessage = f'Raw oxide plots done! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    plt.figure(figsize=(6.5*cm,6.5*cm))
    fig, axs = plt.subplots(2, 3)
    a0       = axs[0,0].imshow(NK_A,cmap='viridis',vmin=0, vmax=2)
    a0.cmap.set_over('black')
    ...
    axs[0,1].axis("off")
    fig.colorbar(a1)
    a2       = axs[0,2].imshow(Mf,cmap='viridis',vmin=0, vmax=5)
    a2.cmap.set_under('black')
    axs[0,2].set_title("M$_{f}$")
    axs[0,2].axis("off")
    fig.colorbar(a2)
    a3       = axs[1,0].imshow(Mg_MgFe2,cmap='viridis',vmin=0, vmax=1)
    a3.cmap.set_over('black')
    axs[1,0].set_title("XMg$_{Fe2+}$")
    axs[1,0].axis("off")
    fig.colorbar(a3)
    a4       = axs[1,1].imshow(K_Na,cmap='viridis',vmin=0, vmax=5)
    a4.cmap.set_under('black')
    axs[1,1].set_title("K/Na")
    axs[1,1].axis("off")
    fig.colorbar(a4)
    a5       = axs[1,2].imshow(DI,cmap='viridis',vmin=0, vmax=100)
    a5.cmap.set_over('black')
    ...
    st10 = time.time()
    elapsed_time = st10 - st0 - (st1p-st1)
    tmessage = f'Chemical index plots done! Total elapsed time: {elapsed_time:.1f} seconds'
    print(tmessage)
    ...
    et = time.time()
    elapsed_time = et - st0 - (st1p-st1)
    tmessage = f'Total execution time: {elapsed_time:.1f} seconds'
    print(tmessage)